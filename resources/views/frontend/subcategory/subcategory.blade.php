			...
			<div class="col-lg-2 col-md-12 col-sm-12 col-12 d-none d-sm-block p-0">
				...
				{{-- <ul class="list-group">
					...
					<li class="list-group-item" style=" border-radius: 0px;">
						<a href="{{url('subcategory/'.$SubCategoryNameshow->id)}}">{{$SubCategoryNameshow->subcategory_name}}</a>
					</li>
					@endforeach
					@endif
				</ul> --}}
			...
			<div class="col-lg-10 col-md-12 col-sm-12 col-12">
				...
				<div>
					...
					<ul class="uk-breadcrumb" style="margin-top: -7px;">
						<li style="color: #666;">
							...
							<span class="text-uppercase"> &nbsp;&nbsp; / &nbsp;&nbsp; {{$SubCategoryName->item_name}}</span>
							<span class="text-uppercase"> &nbsp;&nbsp; / &nbsp;&nbsp; {{$SubCategoryName->category_name}}</span>
							<span class="text-uppercase"> &nbsp;&nbsp; / &nbsp;&nbsp; {{$SubCategoryName->subcategory_name}}</span>
						</li>
					</ul>
				...
				<div class="col-sm-12 col-12 p-0" style="margin-top: 4px;">
					<div class="row" id="showproduct-130">
						...
						@if(isset($SubCategoryProduct))
						@foreach($SubCategoryProduct as $SubCategoryProductshow)
						...
						<div class="col-lg-3 cl-md-4 col-sm-6 col-6 mt-4" >
							<div class="homeproducts border">
								...
								<center>
									<a href="{{url('product/'.$SubCategoryProductshow->id)}}"><img src="{{ url($SubCategoryProductshow->image) }}" class="img-fluid" style="z-index:1; "></a>
								</center>
								<div>
									<a href=""><center>
										@php
