...
<div class="col-md-12 " style="padding-bottom: 10px; background-color: #fff; ">
	<div class="container-fluid padd">
		<div class="row">
			...
			<div class="col-xl-3 col-lg-3 col-md-4 col-sm-12 col-12 mt-5" >
			...
			<div class="col-xl-9 col-lg-9 col-md-8 col-sm-7 col-12 mt-5">
				<div class="col-md-12 p-4 userdashboard" style="border-top: 1px solid #ddd;">
					...
					<div class="row">
						...
						<div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12 mt-4">
							<div class="dash p-3" style="background-color: #E10048">
								@if(isset($PendingOrder))
								<label>{{count($PendingOrder)}}</label><br>
						...
						<div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12 mt-4">
							<div class="dash p-3" style="background-color: #4285F4">
						...
						<div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12 mt-4">
							<div class="dash p-3" style="background-color: #7B0099">
								@if(isset($ShippingOrder))
								<label>{{count($ShippingOrder)}}</label><br>
								<a href="{{url('allorder')}}" style="text-decoration:none;">Shipping Order</a>
								@endif
							</div>
						</div>

						<div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12 mt-4">
							<div class="dash p-3" style="background-color: #00df00">
								@if(isset($CompeleteOrder))
								<label>{{count($CompeleteOrder)}}</label><br>
