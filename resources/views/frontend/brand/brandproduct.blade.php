	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-lg-2 col-md-12 col-sm-12 col-12 d-none d-sm-block p-0">
				...
				<ul class="list-group">
					@if(isset($Brandlist))
					@foreach($Brandlist as $Brandlistshow)

					@php
					$products = DB::table('productinformation')->where('brand_id',$Brandlistshow->id)->first();
					@endphp

					@if($products)

					<li class="list-group-item" style=" border-radius: 0px;">
						<a href="{{url('brandproduct/'.$Brandlistshow->id)}}" style="text-decoration:none; color: black;">{{$Brandlistshow->brand_name}}</a>
					</li>
					@else
					@endif
					@endforeach
			...
			<div class="col-lg-10 col-md-12 col-sm-12 col-12">
				...
				<div class="col-sm-12 col-12 p-0" style="margin-top: 4px;">
					<div class="row" id="showproduct-130">
						...
						@foreach($BrandProduct as $BrandProductshow)
						...
						<div class="col-lg-3 cl-md-4 col-sm-6 col-6 mt-4" >
							<div class="homeproducts border">
								...
								<center>
									<a href="{{url('product/'.$BrandProductshow->id)}}"><img src="{{ url($BrandProductshow->image) }}" class="img-fluid" style="z-index:1; "></a>
								</center>
								<div>
									<a href=""><center>
										@php
										$content = substr($BrandProductshow->product_name,0,20);
