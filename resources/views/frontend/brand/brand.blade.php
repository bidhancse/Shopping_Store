	...
	<div class="container-fluid">
		<div class="col-sm-12 col-12">
			...
			<div class="row" style="background:#fff; margin-top: 30px;">
				@if(isset($Allbrand))
				@foreach($Allbrand as $AllbrandShow)
				<div class="p-2 col-lg-1 col-md-3 col-sm-4 col-4"
				style="background:#fff; border: 3px #f4f4f4  solid; align:center; ">

				<center style="padding:5px;">
					<a href="{{ url('brandproduct/'.$AllbrandShow->id) }}">

						@if(isset($AllbrandShow->image))
						<img src="{{ url($AllbrandShow->image) }}" class="img-responsive" alt=""
